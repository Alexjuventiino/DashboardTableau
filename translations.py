...
TRANSLATIONS = {
    "fr": {
        ...
        "perf_by_type_title":    "Par type d'événement",
        "perf_by_type_caption":  "Top 20 types, triés par temps total décroissant.",
    ...
    "en": {
        ...
        "perf_by_type_title":    "By event type",
        "perf_by_type_caption":  "Top 20 types, sorted by total time descending.",
